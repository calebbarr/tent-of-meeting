TentOfMeeting::Application.routes.draw do  
  ...
  match "/Philemon/:chapter/:verse/quiz/create", :controller => :quizzes, :action => :create, book: 57
  ...
  match "/1John/:chapter/:verse/quiz/create", :controller => :quizzes, :action => :create, book: 62
