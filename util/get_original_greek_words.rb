...
$original_words_file = File.open("../resources/all_original_greek_words.rb", "w")
$curr_row = 2
#used in getting long definition from other site
$url_stem = "http://concordances.org/greek/"
...
def process_uninflected(strongs_num)
  begin
    ...
    medium_definition = (doc/"/html/body/table[2]/tr/td[2]/table[2]/tr/td/text()")[4].to_s.gsub("\"","\\\"")
    ...
    long_definition_url = "http://www.sacrednamebible.com/kjvstrongs/STRGRK"+((strongs_num-1)/100).to_s+".htm"
    ...
    nt_greek_word_string = "NTGreekWord.create({"
    nt_greek_word_string += "strong_id: "
    nt_greek_word_string += strongs_num.to_s + ", "
    nt_greek_word_string += "form: "
    nt_greek_word_string += "\""+form+"\"" +", "
    nt_greek_word_string += "pos: "
    nt_greek_word_string += "\""+pos+"\"" +", "
    nt_greek_word_string += "transliteration: "
    nt_greek_word_string += "\""+transliteration+"\"" +", "
    nt_greek_word_string += "phonetic_spelling: "
    nt_greek_word_string += "\""+phonetic_spelling+"\"" +", "
    nt_greek_word_string += "short_definition: "
    nt_greek_word_string += "\""+short_definition+"\"" +", "
    nt_greek_word_string += "medium_definition: "
    nt_greek_word_string += "\""+medium_definition+"\"" +", "
    nt_greek_word_string += "long_definition: "
    nt_greek_word_string += "\""+long_definition+"\""
    nt_greek_word_string += " })"
    
    NTGreekWord.create({ strong_id: strongs_num, form: form, pos: pos, transliteration: transliteration, phonetic_spelling: phonetic_spelling, short_definition: short_definition, medium_definition: medium_definition, long_definition: long_definition})
  
    $original_words_file.puts(nt_greek_word_string)
    # puts "short def:"
