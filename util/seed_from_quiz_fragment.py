#script to convert output of python generation script to rails seeding script
...
new_seeds = open("../resources/generated_seeds.rb","a")
numbers_letters = {
1 : "a",
2 : "b",
3 : "c",
...
question_answers = open('../resources/quiz_file','r').read().split('\n\n')
